...
;// CONCATENATED MODULE: ./src/components/M_PostTeaser/M_PostTeaser.jsx
function M_PostTeaser_typeof(o) { "@babel/helpers - typeof"; return M_PostTeaser_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, M_PostTeaser_typeof(o); }
function M_PostTeaser_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function M_PostTeaser_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, M_PostTeaser_toPropertyKey(descriptor.key), descriptor); } }
function M_PostTeaser_createClass(Constructor, protoProps, staticProps) { if (protoProps) M_PostTeaser_defineProperties(Constructor.prototype, protoProps); if (staticProps) M_PostTeaser_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function M_PostTeaser_toPropertyKey(arg) { var key = M_PostTeaser_toPrimitive(arg, "string"); return M_PostTeaser_typeof(key) === "symbol" ? key : String(key); }
function M_PostTeaser_toPrimitive(input, hint) { if (M_PostTeaser_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (M_PostTeaser_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function M_PostTeaser_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) M_PostTeaser_setPrototypeOf(subClass, superClass); }
function M_PostTeaser_setPrototypeOf(o, p) { M_PostTeaser_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return M_PostTeaser_setPrototypeOf(o, p); }
function M_PostTeaser_createSuper(Derived) { var hasNativeReflectConstruct = M_PostTeaser_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = M_PostTeaser_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = M_PostTeaser_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return M_PostTeaser_possibleConstructorReturn(this, result); }; }
function M_PostTeaser_possibleConstructorReturn(self, call) { if (call && (M_PostTeaser_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return M_PostTeaser_assertThisInitialized(self); }
function M_PostTeaser_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function M_PostTeaser_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function M_PostTeaser_getPrototypeOf(o) { M_PostTeaser_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return M_PostTeaser_getPrototypeOf(o); }
// import './M_PostTeaser.scss'


var M_PostTeaser = /*#__PURE__*/function (_React$Component) {
  M_PostTeaser_inherits(M_PostTeaser, _React$Component);
  var _super = M_PostTeaser_createSuper(M_PostTeaser);
  function M_PostTeaser() {
    M_PostTeaser_classCallCheck(this, M_PostTeaser);
    return _super.apply(this, arguments);
  }
  M_PostTeaser_createClass(M_PostTeaser, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
      ...
      tags.forEach(function (tag, i) {
        tagElements.push( /*#__PURE__*/react.createElement(A_Text, {
          type: "tag",
          text: tag,
          key: i
        }));
...
;// CONCATENATED MODULE: ./src/components/S_SearchContent/S_SearchContent.jsx
function S_SearchContent_typeof(o) { "@babel/helpers - typeof"; return S_SearchContent_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, S_SearchContent_typeof(o); }
function S_SearchContent_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function S_SearchContent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, S_SearchContent_toPropertyKey(descriptor.key), descriptor); } }
function S_SearchContent_createClass(Constructor, protoProps, staticProps) { if (protoProps) S_SearchContent_defineProperties(Constructor.prototype, protoProps); if (staticProps) S_SearchContent_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function S_SearchContent_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) S_SearchContent_setPrototypeOf(subClass, superClass); }
function S_SearchContent_setPrototypeOf(o, p) { S_SearchContent_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return S_SearchContent_setPrototypeOf(o, p); }
function S_SearchContent_createSuper(Derived) { var hasNativeReflectConstruct = S_SearchContent_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = S_SearchContent_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = S_SearchContent_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return S_SearchContent_possibleConstructorReturn(this, result); }; }
function S_SearchContent_possibleConstructorReturn(self, call) { if (call && (S_SearchContent_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return S_SearchContent_assertThisInitialized(self); }
function S_SearchContent_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function S_SearchContent_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function S_SearchContent_getPrototypeOf(o) { S_SearchContent_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return S_SearchContent_getPrototypeOf(o); }
function S_SearchContent_defineProperty(obj, key, value) { key = S_SearchContent_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function S_SearchContent_toPropertyKey(arg) { var key = S_SearchContent_toPrimitive(arg, "string"); return S_SearchContent_typeof(key) === "symbol" ? key : String(key); }
function S_SearchContent_toPrimitive(input, hint) { if (S_SearchContent_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (S_SearchContent_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
var S_SearchContent = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = S_SearchContent_createSuper(S_SearchContent);
  function S_SearchContent(props) {
    var _this;
    S_SearchContent_classCallCheck(this, S_SearchContent);
    ...
    S_SearchContent_defineProperty(S_SearchContent_assertThisInitialized(_this), "renderPostTeasers", function () {
      ...
      postTeasers.forEach(function (teaser) {
        ...
        if (title.includes(searchInputValue) || description.includes(searchInputValue)) {
          posts.push( /*#__PURE__*/react.createElement(M_PostTeaser, {
            title: title,
    ...
    var _searchInputValue = _this.props.searchInputValue;
    _this.state = {
  ...
  S_SearchContent_createClass(S_SearchContent, [{
    ...
    value: function render() {
      return /*#__PURE__*/react.createElement("div", {
        className: "S_SearchContent"
      }, this.renderPostTeasers());
    }
  }]);
  return S_SearchContent;
}(react.Component);

;// CONCATENATED MODULE: ./src/search.jsx
...
var root = client/* createRoot */.s(document.querySelector('.W_ContentReactModule'));
root.render( /*#__PURE__*/react.createElement(S_SearchContent, {
