...
;// CONCATENATED MODULE: ./src/search-vanila-data.js
// patwrAk6UV3MCu9k6.ffb941cbed52585800fc41fe696b973a2c292f368197eae119421cde989f97b7

var token = 'patwrAk6UV3MCu9k6.ffb941cbed52585800fc41fe696b973a2c292f368197eae119421cde989f97b7';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('app6xXNrXQb1jG82N');
function getPostTeasures() {
  return new Promise(function (resolve, reject) {
    var content = [];
    base('veranda-data').select({
      maxRecords: 30
...
;// CONCATENATED MODULE: ./src/components/A_MainMenu/A_MainMenu.jsx
...
var A_MainMenu = /*#__PURE__*/function (_React$Component) {
  _inherits(A_MainMenu, _React$Component);
  var _super = _createSuper(A_MainMenu);
  function A_MainMenu() {
    _classCallCheck(this, A_MainMenu);
    return _super.apply(this, arguments);
  }
  _createClass(A_MainMenu, [{
    key: "render",
...
function A_Input_typeof(o) { "@babel/helpers - typeof"; return A_Input_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, A_Input_typeof(o); }
...
function A_Input_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, A_Input_toPropertyKey(descriptor.key), descriptor); } }
...
function A_Input_defineProperty(obj, key, value) { key = A_Input_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function A_Input_toPropertyKey(arg) { var key = A_Input_toPrimitive(arg, "string"); return A_Input_typeof(key) === "symbol" ? key : String(key); }
function A_Input_toPrimitive(input, hint) { if (A_Input_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (A_Input_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
// import './A_Input.scss'
...
function A_Button_defineProperty(obj, key, value) { key = A_Button_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function A_Button_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, A_Button_toPropertyKey(descriptor.key), descriptor); } }
...
function A_Button_toPropertyKey(arg) { var key = A_Button_toPrimitive(arg, "string"); return A_Button_typeof(key) === "symbol" ? key : String(key); }
function A_Button_toPrimitive(input, hint) { if (A_Button_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (A_Button_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
;// CONCATENATED MODULE: ./src/components/M_SearchForm/M_SearchForm.jsx
function M_SearchForm_typeof(o) { "@babel/helpers - typeof"; return M_SearchForm_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, M_SearchForm_typeof(o); }
function M_SearchForm_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function M_SearchForm_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, M_SearchForm_toPropertyKey(descriptor.key), descriptor); } }
function M_SearchForm_createClass(Constructor, protoProps, staticProps) { if (protoProps) M_SearchForm_defineProperties(Constructor.prototype, protoProps); if (staticProps) M_SearchForm_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function M_SearchForm_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) M_SearchForm_setPrototypeOf(subClass, superClass); }
function M_SearchForm_setPrototypeOf(o, p) { M_SearchForm_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return M_SearchForm_setPrototypeOf(o, p); }
function M_SearchForm_createSuper(Derived) { var hasNativeReflectConstruct = M_SearchForm_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = M_SearchForm_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = M_SearchForm_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return M_SearchForm_possibleConstructorReturn(this, result); }; }
function M_SearchForm_possibleConstructorReturn(self, call) { if (call && (M_SearchForm_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return M_SearchForm_assertThisInitialized(self); }
function M_SearchForm_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function M_SearchForm_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function M_SearchForm_getPrototypeOf(o) { M_SearchForm_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return M_SearchForm_getPrototypeOf(o); }
function M_SearchForm_defineProperty(obj, key, value) { key = M_SearchForm_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function M_SearchForm_toPropertyKey(arg) { var key = M_SearchForm_toPrimitive(arg, "string"); return M_SearchForm_typeof(key) === "symbol" ? key : String(key); }
function M_SearchForm_toPrimitive(input, hint) { if (M_SearchForm_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (M_SearchForm_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
// import './M_SearchForm.scss'



var M_SearchForm = /*#__PURE__*/function (_React$Component) {
  M_SearchForm_inherits(M_SearchForm, _React$Component);
  var _super = M_SearchForm_createSuper(M_SearchForm);
  function M_SearchForm(props) {
    var _this;
    M_SearchForm_classCallCheck(this, M_SearchForm);
    _this = _super.call(this, props);
...
function A_Text_defineProperty(obj, key, value) { key = A_Text_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function A_Text_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, A_Text_toPropertyKey(descriptor.key), descriptor); } }
...
function A_Text_toPropertyKey(arg) { var key = A_Text_toPrimitive(arg, "string"); return A_Text_typeof(key) === "symbol" ? key : String(key); }
function A_Text_toPrimitive(input, hint) { if (A_Text_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (A_Text_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function M_PostSuggestion_typeof(o) { "@babel/helpers - typeof"; return M_PostSuggestion_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, M_PostSuggestion_typeof(o); }
...
function M_PostSuggestion_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, M_PostSuggestion_toPropertyKey(descriptor.key), descriptor); } }
...
function M_PostSuggestion_toPropertyKey(arg) { var key = M_PostSuggestion_toPrimitive(arg, "string"); return M_PostSuggestion_typeof(key) === "symbol" ? key : String(key); }
function M_PostSuggestion_toPrimitive(input, hint) { if (M_PostSuggestion_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (M_PostSuggestion_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
;// CONCATENATED MODULE: ./src/components/O_SearchBar/O_SearchBar.jsx
function O_SearchBar_typeof(o) { "@babel/helpers - typeof"; return O_SearchBar_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, O_SearchBar_typeof(o); }
function O_SearchBar_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function O_SearchBar_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, O_SearchBar_toPropertyKey(descriptor.key), descriptor); } }
function O_SearchBar_createClass(Constructor, protoProps, staticProps) { if (protoProps) O_SearchBar_defineProperties(Constructor.prototype, protoProps); if (staticProps) O_SearchBar_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function O_SearchBar_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) O_SearchBar_setPrototypeOf(subClass, superClass); }
function O_SearchBar_setPrototypeOf(o, p) { O_SearchBar_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return O_SearchBar_setPrototypeOf(o, p); }
function O_SearchBar_createSuper(Derived) { var hasNativeReflectConstruct = O_SearchBar_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = O_SearchBar_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = O_SearchBar_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return O_SearchBar_possibleConstructorReturn(this, result); }; }
function O_SearchBar_possibleConstructorReturn(self, call) { if (call && (O_SearchBar_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return O_SearchBar_assertThisInitialized(self); }
function O_SearchBar_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function O_SearchBar_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function O_SearchBar_getPrototypeOf(o) { O_SearchBar_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return O_SearchBar_getPrototypeOf(o); }
function O_SearchBar_defineProperty(obj, key, value) { key = O_SearchBar_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function O_SearchBar_toPropertyKey(arg) { var key = O_SearchBar_toPrimitive(arg, "string"); return O_SearchBar_typeof(key) === "symbol" ? key : String(key); }
function O_SearchBar_toPrimitive(input, hint) { if (O_SearchBar_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (O_SearchBar_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
var O_SearchBar = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = O_SearchBar_createSuper(O_SearchBar);
  function O_SearchBar() {
    var _this;
    O_SearchBar_classCallCheck(this, O_SearchBar);
    ...
    O_SearchBar_defineProperty(O_SearchBar_assertThisInitialized(_this), "renderPostSuggestions", function () {
      var postTeasers = _this.props.postTeasers;
      var posts = [];
      var searchInputValue = _this.props.searchInputValue.toLowerCase();
      postTeasers.forEach(function (teaser) {
        var nbspRegex = /[\u202F\u00A0]/gm;
        var punctuationRegex = /[.\/#$%\^\*{}=\_`~()]/gm;
        var title = teaser.title.replaceAll(nbspRegex, ' ').replaceAll(punctuationRegex, '').toLowerCase();
        var description = teaser.description.replaceAll(nbspRegex, ' ').replaceAll(punctuationRegex, '').toLowerCase();
        if (title.includes(searchInputValue) || description.includes(searchInputValue)) {
      ...
      var postSuggestionsStyle = {
        display: posts.length === 0 ? 'none' : 'block'
      };
      return /*#__PURE__*/react.createElement("div", {
        className: "C_PostSuggestions",
        style: postSuggestionsStyle
      }, /*#__PURE__*/react.createElement("div", {
        className: "A_ScrollSearch"
      }, posts));
    });
    return _this;
  }
  O_SearchBar_createClass(O_SearchBar, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
        isSearchButtonDisabled = _this$props.isSearchButtonDisabled,
      ...
      }), searchInputValue.length >= 3 && !isSearchButtonDisabled && this.renderPostSuggestions());
    }
  }]);
  return O_SearchBar;
}(react.Component);

;// CONCATENATED MODULE: ./src/components/S_MenuBar/S_MenuBar.jsx
function S_MenuBar_typeof(o) { "@babel/helpers - typeof"; return S_MenuBar_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, S_MenuBar_typeof(o); }
function S_MenuBar_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function S_MenuBar_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, S_MenuBar_toPropertyKey(descriptor.key), descriptor); } }
function S_MenuBar_createClass(Constructor, protoProps, staticProps) { if (protoProps) S_MenuBar_defineProperties(Constructor.prototype, protoProps); if (staticProps) S_MenuBar_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function S_MenuBar_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) S_MenuBar_setPrototypeOf(subClass, superClass); }
function S_MenuBar_setPrototypeOf(o, p) { S_MenuBar_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return S_MenuBar_setPrototypeOf(o, p); }
function S_MenuBar_createSuper(Derived) { var hasNativeReflectConstruct = S_MenuBar_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = S_MenuBar_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = S_MenuBar_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return S_MenuBar_possibleConstructorReturn(this, result); }; }
function S_MenuBar_possibleConstructorReturn(self, call) { if (call && (S_MenuBar_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return S_MenuBar_assertThisInitialized(self); }
function S_MenuBar_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function S_MenuBar_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function S_MenuBar_getPrototypeOf(o) { S_MenuBar_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return S_MenuBar_getPrototypeOf(o); }
function S_MenuBar_defineProperty(obj, key, value) { key = S_MenuBar_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function S_MenuBar_toPropertyKey(arg) { var key = S_MenuBar_toPrimitive(arg, "string"); return S_MenuBar_typeof(key) === "symbol" ? key : String(key); }
function S_MenuBar_toPrimitive(input, hint) { if (S_MenuBar_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (S_MenuBar_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }




var S_MenuBar = /*#__PURE__*/function (_React$Component) {
  S_MenuBar_inherits(S_MenuBar, _React$Component);
  var _super = S_MenuBar_createSuper(S_MenuBar);
  function S_MenuBar(props) {
    var _this;
    S_MenuBar_classCallCheck(this, S_MenuBar);
    _this = _super.call(this, props);
    S_MenuBar_defineProperty(S_MenuBar_assertThisInitialized(_this), "handleSearchInput", function (searchInputValue) {
    ...
    S_MenuBar_defineProperty(S_MenuBar_assertThisInitialized(_this), "handleSearchSubmit", function () {
      var _this$props = _this.props,
        prerender = _this$props.prerender,
    ...
    var _searchInputValue = props.prerender ? '' : props.searchInputValue;
    _this.state = {
  ...
  S_MenuBar_createClass(S_MenuBar, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      getPostTeasures().then(function (data) {
        _this2.setState({
          postTeasers: data
        });
      });
    ...
    value: function render() {
      var _this$props2 = this.props,
        prerender = _this$props2.prerender,
      ...
      var currentURL = prerender == undefined ? window.location.href : '';
      var menuElements = [];
      menu.forEach(function (menuItem, i) {
        var text = menuItem.text,
          url = menuItem.url;
        var linkURL = homeURL + url;
        menuElements.push( /*#__PURE__*/react.createElement(A_MainMenu, {
          text: text,
          type: "mainMenuItem",
...
;// CONCATENATED MODULE: ./src/menubar.jsx
...
var root = client/* createRoot */.s(document.querySelector('.S_MenuBar '));
root.render( /*#__PURE__*/react.createElement(S_MenuBar, _extends({
